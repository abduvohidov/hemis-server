...
CREATE TABLE "Education" (
    ...
    "scientificInternshipPlace" TEXT NOT NULL,
...
CREATE TABLE "Articles" (
    ...
    "firstArticleDate" DATE NOT NULL,
    "firstArticleJournal" TEXT NOT NULL,
    "firstArticleFilename" TEXT NOT NULL DEFAULT '',
    "secondArticle" TEXT NOT NULL,
    "secondArticleDate" DATE NOT NULL,
    "secondArticleJournal" TEXT NOT NULL,
    "secondArticleFilename" TEXT NOT NULL DEFAULT '',
